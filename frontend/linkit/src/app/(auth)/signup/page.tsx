...
export default function CreateAccount() {
  return (
    <div className='lg:h-screen py-20 lg:py-0 bg-black w-full flex justify-center items-center'>
      <SignUp
        path={"/signup"}
        signInUrl={"/login"}
        appearance={{
          elements: {
            ...
            footerActionText: 'text-white -mt-4',
            footerActionLink: 'hover:bg-gradient-to-r hover:from-teal-300 hover:via-blue-500 hover:to-noto-purple  hover:text-transparent hover:bg-clip-text text-white -mt-4',
          }
        }} />
    </div>
  );
