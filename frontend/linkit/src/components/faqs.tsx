...
export default function FAQs(): JSX.Element {
  ...
  return (
    <section
      className="bg-[#12141F] flex justify-center py-16 text-[#FAFAFA]"
      id="faqs"
    >
      <div className="max-w-lg">
        <div className="space-y-4 ml-4 mr-4">
          <div className="mx-auto max-w-lg text-center">
            <div className="lg:text-5xl text-3xl font-bold mb-10">
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <p className="mt-4 px-4 leading-relaxed">No, notespace is free!</p>
          </details>
