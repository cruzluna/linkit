      ...
      >
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
                type="button"
                className="border border-noto-purple block hover:bg-noto-purple text-white font-bold px-9 py-3 rounded hidden lg:inline-block"
              ...
              <button
                type="button"
                className="bg-noto-purple block border border-noto-purple hover:bg-[#12141F] text-white font-bold px-9 py-3 rounded hidden lg:inline-block"
