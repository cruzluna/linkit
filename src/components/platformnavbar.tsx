                ...
                <div className="relative p-6 flex-auto">
                  <section className="bg-[#1C202F] ">
                    <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-[#FAFAFA]">Share Your Notespace</h2>
                      <p className="mb-4 lg:mb-8 font-light text-center text-gray-200 sm:text-xl">Copy and paste your link anywhere</p>
                      <div className="flex justify-center mb-8"> {/* Added container */}
                        <a href={profileUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center p-5 bg-[#12141F] text-base font-medium text-gray-500 rounded-lg hover:text-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
