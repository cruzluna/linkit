        ...
        <div className="container m-auto px-6 text-[#FAFAFA] md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            <div className="md:7/12 lg:w-6/12">
              <div className="text-sm font-bold ml-0.5 mb-2 tracking-widest text-noto-purple">
                LINK ENGAGEMENT DASHBOARD
              </div>
              <h2 className="lg:text-5xl text-3xl font-bold text-[#FAFAFA]">
              ...
              <p className="mt-4 ">
                Gain insights into your link&apos;s performance with detailed
                analytics, tracking views and clicks to optimize your online
                presence.
              </p>
            </div>
